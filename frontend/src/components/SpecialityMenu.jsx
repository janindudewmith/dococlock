...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      <h1 className='text-4xl font-medium tracking-[0.1em]'>Find by Specialty</h1>
      <p className='sm:w-1/3 text-center text-sm'>Your health, in the hands of the experts in the field.</p>
