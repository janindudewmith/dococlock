...
const DoctorAppointments = () => {
  const { dToken, appointments, getAppointments, completeAppointment, cancelAppointment, loading } = useContext(DoctorContext);
          ...
          {appointments.reverse().map((item, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <img className="w-8 rounded-full" src={item.userData.image} alt={`${item.userData.name}'s profile`} />
